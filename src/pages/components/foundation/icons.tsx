          ...
          <Stack spacing={3}>
            ...
            <Box sx={{ position: 'relative' }}>
              <Block title="Local Icons" sx={style}>
                ...
                />
                <SvgIconStyle
                  src="https://minimal-assets-api-dev.vercel.app/assets/icons/elephant.svg"
                  sx={{ color: 'info.main' }}
                />
                <SvgIconStyle
                  src="https://minimal-assets-api-dev.vercel.app/assets/icons/json-logo.svg"
                  sx={{ color: 'success.main' }}
                />
                <SvgIconStyle
                  src="https://minimal-assets-api-dev.vercel.app/assets/icons/love-camera.svg"
                  sx={{ color: 'warning.main' }}
                />
                <SvgIconStyle
                  src="https://minimal-assets-api-dev.vercel.app/assets/icons/shield.svg"
                  sx={{ color: 'error.main' }}
                />
              </Block>
            </Box>
